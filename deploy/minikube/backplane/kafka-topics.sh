...
kafka-topics --bootstrap-server backplane-kafka-0.backplane-kafka.cecochat.svc.cluster.local:9092 --create --topic config-changes --partitions 12 --replication-factor 2 --config min.insync.replicas=2
